    ...
    public class AccountController : Controller
    {
        ...
        public IActionResult Register(UserRegisterViewModel userRegisterViewModel)
        {
            ...
            var user = new DataLayer.Entities.User.User()
            {
                ...
                UserEmail = userRegisterViewModel.UserEmail.TextFix(),
            ...
            rolesId.Add(2);
            _userRepository.InsertRolesToUser(userId, rolesId);
        ...
        public ActionResult Login(LoginViewModel loginViewModel)
        {
            ...
            else
            {
                ...
                {
                    ModelState.AddModelError("UserEmail", "حساب کاربری شما فعال نشده است");
                    loginViewModel.UserPassword = null;
                    return View(loginViewModel);
                }
